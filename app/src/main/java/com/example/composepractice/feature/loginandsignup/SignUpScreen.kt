...
@Composable
private fun BottomSheet(navController : NavHostController ,viewModel: LoginAndSignUpViewModel = hiltViewModel())
{
    ...
    Column(
        ...
        Column(
            ...
            Headings(
                "Get started free.", Color.Black, TextStyle(
                    fontSize = 15.sp, fontFamily =
                        FontFamily(
            ...
            Headings(
                "Enter your details bellow", Color.Black, TextStyle(
                    fontSize = 12.sp, fontFamily =
                        FontFamily(
        ...
        Column(
            ...
            SignUpInputFields(
                ...
                onValueChange = viewModel::onUserNameChange , isPassword = false
            )
        ...
        Column(
            modifier = Modifier
                ...
                .clickable { viewModel.onSignUpClicked(context) }
        ...
        Headings(
            "Forgot password", Color.Gray, TextStyle(
                fontSize = 15.sp, fontFamily =
                    FontFamily(
                        Font(R.font.poppins_semibold)
                    ), textAlign = TextAlign.Center
        ...
        Row(modifier = Modifier
            ...
            Headings(
                "Or sign up with", Color.Gray, TextStyle(
                    fontSize = 12.sp, fontFamily =
                        FontFamily(
                            Font(R.font.poppins_semibold)
                        )
        ...
        Row(modifier = Modifier
            ...
            LoginOptions("google" ,  modifier = Modifier
                .weight(1f)
                .background(
            ...
            LoginOptions("facebook" ,  modifier = Modifier
                .weight(1f)
                .background(
                    color = Color.White, shape = RoundedCornerShape(10.dp)
                )
...
@Composable
fun LoginOptions(optionType: String, modifier: Modifier) {

    Column(
        modifier = modifier,
        horizontalAlignment = Alignment.CenterHorizontally, // Centers Row horizontally
        verticalArrangement = Arrangement.Center // Centers Row vertically
    ) {
        Row(
            modifier = Modifier.padding(vertical = 15.dp), // Vertical padding for touch area
            verticalAlignment = Alignment.CenterVertically,
            ...
            Icon(
                ...
                tint = Color.Unspecified // this is use to over write the tint by default black image value
            )
